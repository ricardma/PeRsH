    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TrabFinal___PeRsH.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(TrabFinal___PeRsH.Models.ApplicationDbContext context)
        {
            ...
            var roles = new List<IdentityRole>
            {
                ...
                new IdentityRole { Id = "2", Name = "Utilizador" }
            };
            roles.ForEach(rr => context.Roles.AddOrUpdate(r => r.Id, rr));
            context.SaveChanges();
            ...
            {
                new Comentarios { comentID = 1, conteudo = "Duis tincidunt lectus quis dui viverra vestibulum. Suspendisse vulputate aliquam dui. Nulla elementum dui ut augue. Aliquam vehicula mi at mauris. Maecenas placerat, nisl at consequat rhoncus, sem nunc gravida justo, quis eleifend arcu velit quis lacus.", dataComentario = new DateTime(2016,7,8), likes = 0, dislikes = 0, report = 0, DiscussaoFK = 1, UtilizadorFK = users[1].Id},
                new Comentarios { comentID = 2, conteudo = "Praesent mauris ante, elementum et, bibendum at, posuere sit amet, nibh.", dataComentario = new DateTime(2016,7,9), likes = 0, dislikes = 0, report = 0, DiscussaoFK = 1, UtilizadorFK = users[0].Id },
                new Comentarios { comentID = 3, conteudo = "Maecenas placerat, nisl at consequat rhoncus, sem nunc gravida justo, quis eleifend arcu velit quis lacus.", likes = 0, dislikes = 0, report = 0, dataComentario = new DateTime(2016,7,10), DiscussaoFK = 2, UtilizadorFK = users[1].Id},
                new Comentarios {comentID = 4, conteudo = "Sed odio est, auctor ac, sollicitudin in, consequat vitae, orci. Fusce id felis. ", dataComentario = new DateTime(2016,7,11), likes = 0, dislikes = 0, report = 0, DiscussaoFK = 2, UtilizadorFK = users[1].Id},
                new Comentarios { comentID = 5, conteudo = "Praesent mauris ante, elementum et, bibendum at, posuere sit amet, nibh.", dataComentario = new DateTime(2016,7,12), likes = 0, dislikes = 0, report = 0, DiscussaoFK = 2, UtilizadorFK = users[0].Id },
                new Comentarios { comentID = 6, conteudo = "Duis tincidunt lectus quis dui viverra vestibulum. Suspendisse vulputate aliquam dui. Nulla elementum dui ut augue. Aliquam vehicula mi at mauris. Maecenas placerat, nisl at consequat rhoncus, sem nunc gravida justo, quis eleifend arcu velit quis lacus.", dataComentario = new DateTime(2016,7,13), likes = 0, dislikes = 0, report = 0, DiscussaoFK = 3, UtilizadorFK = users[1].Id},
            };
